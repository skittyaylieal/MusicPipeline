...
public static class DefaultProfiles
{
	...
	public static readonly Profile DefaultProfile = new Profile
	{
		...
		OutputTemplate = "C:/MusicTools/MusicPipeline/Sandbox/Sandbox_Backup/%(artist|uploader).250s/%(album|playlist).250s/%(title).250s.%(ext)s",
	...
	public static readonly Profile WorkingDefaultProfile = new Profile
	{
		...
		OutputTemplate = "C:/Users/filip/Music/YT_Music_Backup/%(artist|uploader).250s/%(album|playlist).250s/%(title).250s.%(ext)s",
